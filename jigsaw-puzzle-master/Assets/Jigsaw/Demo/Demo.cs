...
public class Demo : MonoBehaviour {
        ...
        switch (puzzleImage)
        {
            case 1:
                switch (sizeMode)
                {
                    ...
                    //added later by sristy
                    case 7: jigsawPuzzle.size = new Vector2(25, 20); break;
                    case 8: jigsawPuzzle.size = new Vector2(28, 22); break;
                    case 9: jigsawPuzzle.size = new Vector2(28, 25); break;
                    case 10: jigsawPuzzle.size = new Vector2(30, 25); break;
                        //added later
                }
                break;
            case 2:
                switch (sizeMode)
                {
                    ...
                    //added later by sristy
                    case 7: jigsawPuzzle.size = new Vector2(28, 28); break;
                    case 8: jigsawPuzzle.size = new Vector2(30, 30); break;
                    case 9: jigsawPuzzle.size = new Vector2(32, 32); break;
                    case 10: jigsawPuzzle.size = new Vector2(34, 34); break;
                        //added later
                }
                break;
            case 3:
    ...
    void Pieces()
    {
		...
		if (sizeMode == maxLevel+1) sizeMode = 1;
        SetSize();


        Debug.Log("size: " + sizeMode);
    }
  ...
  //          GUI.Box(new Rect(0, 20, 300, 100), new GUIContent("- SOLVED -\n" + DispTime()));
  //      }
		
    }

    // from here added later by sristy
    ...
    private void Update()
    {
        //Debug.Log("puzzle solved: " + jigsawPuzzle.solved);
        if (jigsawPuzzle.solved && !gameIsOver)
        {
            gameIsOver = true;
            float t = jigsawPuzzle.time;
            DataController.Instance.SubmitNewPlayerScore(t,CustomizedSceneController.activeLevel);
            GameOverPanel.gameObject.SetActive(true);
            result.text = "Solved in " + t + " seconds. \n Best timing: " + DataController.Instance.GetHighScores()[CustomizedSceneController.activeLevel - 1];
        }
    ...
    public void OnclickChangePuzzle()
    {
        Puzzle();
    }
